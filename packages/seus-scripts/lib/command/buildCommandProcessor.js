...
class BuildCommandProcessor extends CommandProcessor {
  ...
  async process() {
    ...
    if(this.buildType === BUILDFTP) new (require('./ftpCommandProcessor'))(this.cli).process();
    else if(this.buildType === BUILDFCM) new (require('./fcmCommandProcessor'))(this.cli).process();
  }
